...
/**
 * Creates an instance of UpdateNetworkApplianceVlan
 */
class UpdateNetworkApplianceVlan extends BaseModel {
    /**
     * @constructor
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            ...
            { name: 'fixedIpAssignments', realName: 'fixedIpAssignments' },
            {
                ...
                array: true,
                type: 'ReservedIpRange2',
            },
            { name: 'dnsNameservers', realName: 'dnsNameservers' },
            { name: 'dhcpOptions', realName: 'dhcpOptions', array: true, type: 'DhcpOption1' },
        ]);
    }
...
module.exports = UpdateNetworkApplianceVlan;
