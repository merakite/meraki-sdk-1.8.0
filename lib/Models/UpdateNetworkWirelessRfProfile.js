...
/**
 * Creates an instance of UpdateNetworkWirelessRfProfile
 */
class UpdateNetworkWirelessRfProfile extends BaseModel {
    /**
     * @constructor
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            ...
            { name: 'apBandSettings', realName: 'apBandSettings', type: 'ApBandSettings1' },
            {
                name: 'twoFourGhzSettings',
                realName: 'twoFourGhzSettings',
                type: 'TwoFourGhzSettings2',
            },
            { name: 'fiveGhzSettings', realName: 'fiveGhzSettings', type: 'FiveGhzSettings2' },
        ]);
    }
...
module.exports = UpdateNetworkWirelessRfProfile;
