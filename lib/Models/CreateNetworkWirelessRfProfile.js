...
/**
 * Creates an instance of CreateNetworkWirelessRfProfile
 */
class CreateNetworkWirelessRfProfile extends BaseModel {
    /**
     * @constructor
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            ...
            { name: 'apBandSettings', realName: 'apBandSettings', type: 'ApBandSettings' },
            {
                name: 'twoFourGhzSettings',
                realName: 'twoFourGhzSettings',
                type: 'TwoFourGhzSettings1',
            },
            { name: 'fiveGhzSettings', realName: 'fiveGhzSettings', type: 'FiveGhzSettings1' },
        ]);
    }
...
module.exports = CreateNetworkWirelessRfProfile;
