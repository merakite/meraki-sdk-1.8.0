...
class Peer extends BaseModel {
    ...
    constructor(obj) {
        ...
        this.remoteId = this.constructor.getValue(obj.remoteId);
        ...
        this.ikeVersion = this.constructor.getValue(obj.ikeVersion, 1);
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            ...
            { name: 'remoteId', realName: 'remoteId' },
            ...
            { name: 'ikeVersion', realName: 'ikeVersion' },
