...
/**
 * Creates an instance of UpdateNetworkSnmp
 */
class UpdateNetworkSnmp extends BaseModel {
    /**
     * @constructor
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            ...
            { name: 'users', realName: 'users', array: true, type: 'User' },
        ]);
    }
...
module.exports = UpdateNetworkSnmp;
