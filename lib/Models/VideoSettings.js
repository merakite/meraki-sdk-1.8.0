...
class VideoSettings extends BaseModel {
    ...
    constructor(obj) {
        ...
        this.mV22XMV72X = this.constructor.getValue(obj.mV22XMV72X || obj['MV22X/MV72X']);
    }
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            { name: 'mV21MV71', realName: 'MV21/MV71', type: 'MV21MV71' },
            { name: 'mV12MV22MV72', realName: 'MV12/MV22/MV72', type: 'MV12MV22MV72' },
            { name: 'mV32', realName: 'MV32', type: 'MV32' },
            { name: 'mV12WE', realName: 'MV12WE', type: 'MV12WE' },
            { name: 'mV22XMV72X', realName: 'MV22X/MV72X', type: 'MV22XMV72X' },
        ]);
    }
