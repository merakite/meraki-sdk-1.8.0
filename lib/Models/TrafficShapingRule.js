...
/**
 * Creates an instance of TrafficShapingRule
 */
class TrafficShapingRule extends BaseModel {
    /**
     * @constructor
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            { name: 'definitions', realName: 'definitions', array: true, type: 'Definition' },
            {
...
module.exports = TrafficShapingRule;
